...
function PresensiTable() {
    ...
    const handleEditClick = async (item) => {
        ...
        try {
            ...
            const [presensiResponse, jadwalResponse, danaKeluarResponse, danaMasukResponse] = await Promise.all(requests);
            ...
            setFormData({
                ...
                danaKeluar: danaKeluarResponse.data.data ?? null,
                danaMasuk: danaMasukResponse.data.data ?? null,
            });
